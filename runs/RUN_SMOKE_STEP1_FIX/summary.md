...
- `python3 tools/validate_workflow_auto_run.py --run-dir /private/tmp/openclaws/Repos/host-adapters-experimental-data/host-adapters/RUN_SMOKE_STEP1_FIX`
